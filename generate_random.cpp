...
int main()
{
    ...
    */
    ...
    answer = "All numbers from 0-5 outputted because it randomizes it because its between 0 and randMax" ; // 1. Write your answer to Q1 in between " "
    ...
    answer = "% means modulo and the answer that will be provided will be the remainder of the division beteen two numbers " ; // 2. Write your answer to Q2 in between " "
    ...
    answer = "% means modulo and the answer that will be provided will be the remainder of the division beteen two numbers between and then adding 3 to the value"  ; // 3. Write your answer to Q3 in between  
    ...
    answer = "It doesnt randomize when you run it the second time. When you get rid of it you use the same sequence of numbers" ; // 4. Write your answer to Q4 in between " "
